...
The cosine dissimilarity between two samples \\A\\ and \\B\\, each of
length \\n\\, is defined as:

\\d(A,B) = 1 - \frac{\sum\_{i}^n A_i B_i}{\sqrt{\sum\_{i}^n A_i^2}
\sqrt{\sum\_{i}^n B_i^2}} \\
