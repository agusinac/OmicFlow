...
Calculates the Bray-Curtis dissimilarity of a Matrix pairwise for each
column.
...
The Bray-Curtis dissimilarity between two samples \\A\\ and \\B\\, each
of length \\n\\, is defined as:

\\d(A,B) = \frac{\sum\_{i}^n \|A_i - B_i\|}{\sum\_{i}^n (A_i + B_i)}\\
...
#>           S100      S103      S115
#> S103 1.0000000                    
#> S115 0.8668133 1.0000000          
#> S120 1.0000000 0.9225948 1.0000000
```
